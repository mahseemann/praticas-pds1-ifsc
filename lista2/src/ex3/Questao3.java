		...
		btnCadastroAluno.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!dataNascimento.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Escreva a data de nascimento:");
				}
				...
				if (!nomeAluno.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Escreva o nome do aluno:");
				}
				...
				if (!cpf.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Escreva o cpf do aluno:");
				}
				...
				if (!matricula.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Escreva o número da matrícula:");
		...
		btnCadastraProfessor.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!nome.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Escreva o nome do professor:");
				}
				...
				if (!cpf.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Escreva o CPF do professor:");
				}
				...
				if (!siape.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Escreva o código siape do professor:");
				}
				...
				if (!nascimentoProf.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Escreva a data de nascimento do professor:");
				}
